...
// TODO: remove ReleaseDQLMessageStream release DQL msgstream
...
func (c *Core) Import(ctx context.Context, req *milvuspb.ImportRequest) (*milvuspb.ImportResponse, error) {
	...
	var pID UniqueID
	if pID, err = c.meta.GetPartitionByName(cID, req.GetPartitionName(), 0); err != nil {
