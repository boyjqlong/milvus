...
type SegmentIndexInfos struct {
	...
	// IndexInfo contains index_name, index_params, and index_size.
	// Note: index_size not exist in earlier meta version, we need to keep compatibility here.
...
var fileDescriptor_4513485a144f6b06 = []byte{
	...
	,
}
