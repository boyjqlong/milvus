...
const (
	...
	CollectionState_CollectionDroppingAndGcConfirmed  CollectionState = 7
)
...
var CollectionState_name = map[int32]string{
	...
	7: "CollectionDroppingAndGcConfirmed",
}
...
var CollectionState_value = map[string]int32{
	...
	"CollectionDroppingAndGcConfirmed":  7,
}
...
var fileDescriptor_975d306d62b73e88 = []byte{
	...
	,
}
