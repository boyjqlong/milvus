...
vector_anns: <
  ...
  placeholder_tag: "$0"
>
)") % vec_float_field_id.get() % field_id.get() % data_type_str %
                value_tag;
...
vector_anns: <
  ...
  placeholder_tag: "$0"
>
)") % vec_float_field_id.get() % int64_field_id.get() % data_type_str % value_tag;
...
vector_anns: <
  ...
  placeholder_tag: "$0"
>
)") % vec_float_field_id.get() % age_fid.get() % field_id.get() % data_type_str;
